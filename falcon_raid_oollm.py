...
results_folder = "results_raid_500k_oollm"
...
train_datasets = [
    Dataset("normal", f"data/raid_500k_oollm_{d}/train/{t}")
    for d in domains for t in ["human", "gpt"]
]
test_datasets = [
    Dataset("normal", f"data/raid_500k_oollm_{d}/test/{t}")
    for d in domains for t in ["human", "gpt"]
]
...
if args.classify:
    ...
    pred_folder = "predictions_raid_500k_maxiter1000/"
